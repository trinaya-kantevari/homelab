...
I use k3s to set up my cluster. I love k3s because it's so lightweight, minimal and so easy to provision.
## Hardware
I run my cluster on an Ubuntu Server installed on a dell laptop. So my cluster is basically a single node cluster for now and I aim to extend it to a multi node cluster eventually.
## GitOps
